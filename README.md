...
- `integration/` — cross-tool integration specs (e.g., `providers.md`, the canonical env-var → provider mapping for Conductor's adapters, and `sync-discipline.md` for scope-aware managed-file update behavior across tool repos).
